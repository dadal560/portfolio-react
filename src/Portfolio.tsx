    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden relative">
      ...
      <section id="contact" className="py-20 px-8 bg-gradient-to-t from-gray-900 to-black">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-6xl font-bold mb-8 bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent">
            Collaborons
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-8 justify-center mb-12">
            <a 
              ...
              className="group flex items-center justify-center px-8 py-4 bg-gradient-to-r from-orange-500 to-red-600 rounded-full font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/25"
            >
            ...
            <a 
              ...
              className="group flex items-center justify-center px-8 py-4 border-2 border-gray-600 rounded-full font-semibold text-lg transition-all duration-300 hover:border-orange-500 hover:text-orange-400 hover:scale-105"
            >
